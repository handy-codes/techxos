    ...
    <footer className="bg-[#131635] text-white md:pt-4 md:pb-8">
      <div className="container mx-auto px-6 max-sm:p-4 py-12">
          ...
          <div className="flex items-center mb-4 gap-6">
            <div className="flex items-center">
              <Image
                ...
                // className="rounded-md max-sm:h-[100px] max-sm:w-[100px] object-cover"
              />
            </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            <h3 className="text-lg font-semibold mb-4 text-[#F89928]">
              Company
            </h3>
            <ul>
              <li className="mb-2">
          ...
          <div>
            ...
            <ul>
              ...
              <li>
                <Link
                  href="/"
                  className=" text-[#CED1E4] cursor-pointer hover:text-[#E5A111] hover:translate-x-1 duration-300"
                  // className="hover:text-[#384bc1] hover:translate-x-1 duration-300 text-[#CED1E4]"
                >
                  Terms of Service
                </Link>
              </li>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex space-x-4">
            <div className="social-icon-wrapper relative w-10 h-10">
              <svg
              ...
              <Link
                href="#"
                className="text-[#F89928] hover:text-white p-2 rounded-full transition-colors duration-300 flex items-center justify-center w-full h-full"
              >
          ...
          <p className="text-sm text-[#CED1E4] mb-2 md:mb-0">
            Developed by{" "}
            <Link
              href="https://www.techxos.com/services"
              className="text-[#F89928] text-lg"
              target="_blank"
