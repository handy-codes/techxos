...
export default function Intro() {
  return (
    <div className="p-3 sm:p-8">
      <div className="bg-[#1A2E05] border border-[#ECEFF1] borders text-[#03FF01] h-[40vh] p-4 sm:p-8 gap-2 sm:gap-2 radius flex flex-col items-center">
        ...
        <p className='text-white text-justify text-[14px] max-sm:hidden md:px-44 md:text-[17px]'>
          ...
          To upload and earn from your own quality course, please contact <span className='text-[blue]'>sales@techxos.com.</span>
        </p>
