...
export default function Intro() {
  return (
    <div className="p-3 sm:p-8">
      <div className="bg-[#1A2E05] border border-[#ECEFF1] borders text-[#5bd55b] h-[40vh] p-4 sm:p-8 gap-2 sm:gap-2 radius flex flex-col items-center">
        <h1 className='sm:font-bold text-[28px] sm:text-[34px] md:text-5xl'>Explore Our Courses</h1>
        <p className='text-white text-justify text-[14px] max-sm:hidden md:px-44 md:text-[17px]'>
          ...
          Soon, we will announce when you can as well upload and earn from your own quality courses.
