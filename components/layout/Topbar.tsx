              ...
              {topRoutes.map((route) =>
                route.label === "OUR COURSES" ? (
                  ...
                  >
                    ...
                    {/* Dropdown Content */}
                    <div
                      className={`absolute top-full right-0 w-screen max-w-4xl bg-white font-semibold text-[#003B65] shadow-lg flex flex-row pt-4 transition-all duration-300 ${
                        isDropdownOpen
                    ...
                    >
                      ...
                      <div className="w-1/2 bg-[#FEE2E2] text-[black] mt-1 grid grid-cols-2 font-bold gap-3 p-6 overflow-y-auto">
