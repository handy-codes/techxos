...
//     // Find the Mathematics JSS course
//     let liveClass = await db.liveClass.findFirst({
//       where: {
...
//     // If course doesn't exist, create it
//     if (!liveClass) {
//       console.log("[LECTURE_GET] Mathematics JSS course not found, creating it");
//       try {
//         // Create a default lecturer if needed
//         let defaultLecturer = await db.liveClassUser.findFirst({
//           where: { role: LiveClassUserRole.LECTURER }
...
//           data: {
//             title: "Mathematics JSS",
//             description: "Master Junior Secondary School Mathematics! Comprehensive coverage of JSS curriculum with expert guidance.",
//             startTime: now,
//             endTime: endDate,
//             zoomLink: "https://zoom.us/j/example",
//             zoomMeetingId: "123456789",
...
//           }
//         });
//         console.log("[LECTURE_GET] Created Mathematics JSS course with price:", liveClass.price);
//       } catch (courseCreateError) {
//         console.error("[LECTURE_GET] Error creating course:", courseCreateError);
//         return new NextResponse("Could not create course record", { status: 500 });
//       }
...
//             startTime: liveClass.startTime < now ? now : liveClass.startTime,
//             endTime: liveClass.endTime < now ? endDate : liveClass.endTime,
//             price: 150000 // Ensure price is 150,000 NGN
//           },
//           include: {
//             lecturer: true
//           }
...
//         date: tomorrow, // Tomorrow
//         recordingUrl: null,
//         title: "Introduction to JSS Mathematics",
//         isRecorded: false
//       },
//       {
//         id: "lecture-2",
...
//       role: userRole,
//       lecturer: {
//         name: liveClass.lecturer?.name || "Mathematics Instructor",
//         email: liveClass.lecturer?.email || "",
//       },
//       courseDetails: {
//         title: liveClass.title,
...
//       materials: [
//         {
//           title: "Getting Started with JSS Mathematics",
//           url: "/materials/jss-mathematics-intro.pdf",
//           type: "pdf"
//         },
//         {
//           title: "Week 1: Number Systems",
//           url: "/materials/jss-mathematics-week1.pdf",
//           type: "pdf"
//         }
//       ]
//     };
